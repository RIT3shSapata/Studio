    ...
    return (
        <div className='w-screen h-screen bg-wiingy-white-500 absolute top-0 left-0'>
            <div className='w-full h-14 2xl:h-20 bg-white flex items-center'>
                <div
                    onClick={toggleModal}
                    className='flex justify-evenly items-center w-1/12 cursor-pointer hover:bg-gray-300 rounded-full ml-2'>
                    <svg
                        className='h-6 w-6 2xl:h-8 2xl:w-10 cursor-pointer p-1 fill-black hover:bg-gray-300 rounded-full'
