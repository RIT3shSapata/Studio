...
const Maze = ({
    ...
    useEffect(() => {
        ...
        renderMaze(context, maze, srcX, srcY, sprite_x, sprite_y, character);
    ...
    const moveRight = () => {
        return new Promise((resolve, reject) => {
            ...
            const move = () => {
                ...
                if (!context) return;
                if (sprite_x_cord.current % FRAMEUPDATE === 0) {
    ...
    const moveDown = () => {
        return new Promise((resolve, reject) => {
            ...
            const move = () => {
                ...
                requestIDRef.current = requestAnimationFrame(move);
                if (sprite_y_cord.current % FRAMEUPDATE === 0) {
                    updateFrame(curFrame, srcX, srcY, true);
                }
